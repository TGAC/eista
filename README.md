...
For more details and further functionality, please refer to the [usage documentation](https://nf-co.re/eista/usage) and the [parameter documentation](https://nf-co.re/eista/parameters).
